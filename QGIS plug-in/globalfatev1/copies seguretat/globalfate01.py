...
class globalfate:
    ...
    def globalfate_run(self):
        ...
        file_rasters = open('files/input_rasters0.txt', 'w')
        ...
        file_params = open('files/input_parameters0.txt', 'w')
        ...
        if a == (len(self.rasters)+len(parameters)):
            ...
            msgBox.exec_()
            if ret > 0:
                rlayer = QgsRasterLayer("files/contaminant_C.txt", "contaminant_concentration_result")
