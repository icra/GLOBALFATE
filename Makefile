GLOBFATE : read_write_rasters.o area_m2_fun.o other_functions.o Flow_accumulation_m2.o Contaminant_accumulation.o RT_lakes_incorporation.o RT_rivers_calculator.o runoff_input.o main.o
	gcc -lm -fopenmp read_write_rasters.o area_m2_fun.o other_functions.o Flow_accumulation_m2.o Contaminant_accumulation.o RT_lakes_incorporation.o RT_rivers_calculator.o runoff_input.o main.o -o GLOBFATE 

main.o : main.c lib.h
	gcc -lm -fopenmp -c main.c
read_write_rasters.o : read_write_rasters.c lib.h
	gcc -lm -fopenmp -c read_write_rasters.c
area_m2_fun.o : area_m2_fun.c main.c lib.h
...
realclean:
	rm GLOBFATE read_write_rasters.o area_m2_fun.o other_functions.o Flow_accumulation_m2.o Contaminant_accumulation.o RT_lakes_incorporation.o RT_rivers_calculator.o runoff_input.o main.o
